...
- ✅ Stub client (페르소나별 canned voice, weights 0)
...
| Voice 보존 | 페르소나 평가와 동일 ([`docs/eval/`](../eval/)) | LoRA 효과 손실 ≤ 5% |

GGUF q4_k_m 의 voice 보존 검증: [`differentia-llm/experiments/06_gguf_export/results.md`](../../../differentia-llm/experiments/06_gguf_export/results.md) — 페르소나 4/5 + 일반 5/5 통과 (greedy stress test).
